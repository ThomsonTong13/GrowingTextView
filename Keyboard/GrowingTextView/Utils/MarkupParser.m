            ...
            if ([tag hasPrefix:@"img"]) {
                ...
                [self.images addObject:
                 [NSDictionary dictionaryWithObjectsAndKeys:
                  ...
                  height, @"height",
                  fileName, @"fileName",
                  [NSNumber numberWithLong:[string length]], @"location",
                  nil]];
                ...
                [imgAttr retain];
#endif
                CTRunDelegateRef delegate = CTRunDelegateCreate(&callbacks, (__bridge_retained void *)(imgAttr)); //3创建CTRun的代理
